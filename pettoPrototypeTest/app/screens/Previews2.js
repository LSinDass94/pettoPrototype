...
class Previews2 extends Component {
  ...
  handleNextPreview = () => {
    ...
    this.props.navigation.navigate('Previews3');
  };
        ...
        <View>
          ...
          >
            ...
            <TouchableOpacity onPress={() => this.handleNextPreview()}>
              <Image style={styles.iPic} source={require('./images/cutedog2.jpg')} />
            </TouchableOpacity>

            <View style={styles.vDetails}>
              <View style={styles.vPet}>
                <Text style={styles.nField}>Max, 2</Text>
                <Text style={styles.lField}>Shitzu</Text>
